...
const ManualEnrollmentModal: React.FC<ManualEnrollmentModalProps> = ({ onClose, onSave }) => {
  ...
  const isFormValid = student.name.trim() !== '' && student.dateOfBirth.trim() !== '';
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                     <div className="md:col-span-1">
                        ...
                        <div className="flex">
                            ...
                            <button type="button" onClick={fetchCep} disabled={isFetchingCep} className="p-2 bg-gray-200 dark:bg-gray-600 rounded-r-lg">{isFetchingCep ? '...' : 'Buscar'}</button>
                        </div>
                    </div>
